            ...
            <div id="invoice">
                ...
                <div class="invoice overflow-auto">
                    <div style="min-width: 600px">
                            ...
                            <div class="row">
                              <h3 class="box-title">Liste des agents</h3><div class="col-sm-13">
                            </div>
                            ...
                            <table>
                                <thead>
                                    ...
                                    <th class="bg-light border border-dark">#</th>
                                            ...
                                            <th class="bg-light border border-dark">Prénom</th>
                                            <th class="bg-light border border-dark">Email</th>                                         
                                            <th class="bg-light border border-dark">Profession</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
