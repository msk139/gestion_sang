             ...
             <div class="row">
                 ...
                 <div class=" col-lg-8 col-xlg-9 col-md-12 text-right">
                     <div class="card">
                         ...
                         <div class="card-body">
                             <form class="form-horizontal form-material" action="<?php echo base_url('Structure/ajout')?>" method="post">
                             <?php echo validation_errors('<div class="alert alert-danger">','</div>');?>
                                 ...
                                 <div class="form-group mb-4 ">
                                     ...
                                     <div class="col-md-12 border-bottom p-0">
                                         <input type="text" name="nom_structure" required
                                 ...
                                 <div class="form-group mb-4">
                                     ...
                                     <div class="col-md-12 border-bottom p-0">
                                         <input type="text" name="lieu_structure" required
                                             class="form-control p-0 border-0">  </div>
                                 </div>
